      ...
      <section className="pt-28 pb-12 md:pt-32 md:pb-16 bg-white">
        <div className="container-custom max-w-3xl font-inter">
          ...
          <div className="prose-content space-y-6 text-gray-600">
            ...
            <h2 className="text-xl font-poppins font-bold text-dark mt-8 mb-3">5. Intellectual Property Protection</h2>
            ...
            <h2 className="text-xl font-poppins font-bold text-dark mt-8 mb-3">6. Limitation of Liability</h2>
            ...
            <h2 className="text-xl font-poppins font-bold text-dark mt-8 mb-3">7. Governing Law & Dispute Resolution</h2>
            ...
            <h2 className="text-xl font-poppins font-bold text-dark mt-8 mb-3">8. Support Contact</h2>
