            ...
            <div>
              <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm sticky top-28">
                ...
                <div className="space-y-3 text-sm font-inter">
                  ...
                  {shipping > 0 && (
                    <p className="text-xs text-primary-500 font-inter">Add ₹{threshold - subtotal} more for free shipping!</p>
                  )}
                ...
                {hasOutOfStockItems ? (
                  <button
                    disabled
                    className="block w-full text-center mt-6 py-3.5 bg-gray-200 text-gray-400 font-semibold rounded-xl cursor-not-allowed font-poppins text-sm"
                  >
